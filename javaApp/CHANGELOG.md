...
### Version [4.2.2]
#### FIX
- 다국어 기능 미사용 매체의 경우 해외 트레픽 차단을 위한 IP - "KR" 기준 화이트 리스팅 
- 테마 바탕색 대비 텍스트 색 보정 값 적용 

### Version [4.2.1]
#### FIX
- 다국어 지원 외 국가 기본 언어 설정 한국어(ko) -> 영어(en)으로 변경
- 네트워크 상태에 따라 오퍼월 캠페인 리스트 표시가 지연 될 때, 다이얼로그 안내 창 팝업
- Gson 2.11.0v 이상 의존 시, java.lang.NoSuchMethodError 에러 발생 버그 픽스
